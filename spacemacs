...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (spell-checking :variables ispell-dictionary 'en-US)
     syntax-checking
     ;; version-control
     treemacs
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "%I@%S")
   dotspacemacs-frame-title-format "%I@%S - %b in %t"
...
before packages are loaded."
  ...
  ;; Set the window size to 1024x800 pixels
  ;; TODO fix this for @2x displays in Linux...
  ...
  ;; Set with `dict-dir /Library/Application Support/cocoAspell/aspell6-en-6.0-0`
  ...
  (setq projectile-project-search-path '("~/Projects/" "~/iCloud Drive/Research Projects/" "~/Developer/"))
  )
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     '(uv-mode folding yaml-mode jupyter zoom lsp-latex lsp-ui lsp-mode reveal-in-osx-finder pbcopy osx-trash osx-dictionary launchctl yapfify pytest py-isort pip-requirements live-py-mode hy-mode helm-pydoc cython-mode company-auctex auctex-latexmk auctex windresize python-mode web-beautify livid-mode skewer-mode simple-httpd json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc company-tern dash-functional tern coffee-mode unfill mwim mmm-mode markdown-toc markdown-mode helm-company helm-c-yasnippet gh-md fuzzy flyspell-correct-helm flyspell-correct flycheck-pos-tip pos-tip flycheck company-statistics company auto-yasnippet yasnippet auto-dictionary ac-
               (ispell auto-co :variables ispell-dictionary 'en_US)
