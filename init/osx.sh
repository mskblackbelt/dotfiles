...
# ~/dotfiles/.osx — modified from original at https://mths.be/osx
...
# Uncomment to disable the sound effects on boot
...
# Uncomment to set highlight color to green
#defaults write NSGlobalDomain AppleHighlightColor -string "0.764700 0.976500 0.568600"

# Set sidebar icon size to small
defaults write NSGlobalDomain NSTableViewDefaultSizeMode -int 1

# Automatically show scrollbars. Possible values: `WhenScrolling`, `Automatic` and `Always`
...
# Uncomment to disable the “Are you sure you want to open this application?” dialog
...
# Uncomment to disable Resume system-wide
#defaults write com.apple.systempreferences NSQuitAlwaysKeepsWindows -bool false

# Uncomment to disable automatic termination of inactive apps
...
defaults write com.apple.Safari HomePage -string "http://stackexchange.com"
...
if [ "${CURRENT_PROFILE}" != "${TERM_PROFILE}" ]; then
	open "${HOME}/dotfiles/init/${TERM_PROFILE}.terminal";
