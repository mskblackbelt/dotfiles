...
# Set dock location to left side of screen
...
# Set Safari’s home page to StackExchange
defaults write com.apple.Safari HomePage -string "https://www.stackexchange.com"
